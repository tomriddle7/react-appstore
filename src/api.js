...
export const getUpcomingApps = () => api.get("/api/v1/kr/ios-apps/new-apps-we-love/all/25/explicit.json");
export const getUpcomingGames = () => api.get("/api/v1/kr/ios-apps/new-games-we-love/all/25/explicit.json");
